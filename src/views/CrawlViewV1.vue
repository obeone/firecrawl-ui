...
export default defineComponent({
  ...
  setup() {
    ...
    if (!clients || clients.version !== 'v1') {
      throw new Error('Crawling API v1 is not available');
    }
    const api = {
      billing: clients.billing as BillingApi,
      crawling: clients.crawling as CrawlingApi,
      extraction: clients.extraction as ExtractionApi,
      mapping: clients.mapping as MappingApi,
      scraping: clients.scraping as ScrapingApi,
    };
